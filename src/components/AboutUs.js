      ...
      <>
        <Container  fluid>
          <Row className="text-center">
            ...
            {/* <h5>
              {" "}
              We are the Reactors, our mission is to spread awareness in our
              community to save animals from hunger and people's cruelty.
            </h5>  */}
          </Row>
              ...
              <Col className="p-2 justify-content-center d-flex">
                <Card  border="primary" style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Title className="text-dark">Full-stack Developer</Card.Title>
